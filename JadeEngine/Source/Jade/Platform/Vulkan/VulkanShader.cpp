...
namespace Jade {
	...
	namespace Vulkan {
		...
		VulkanRenderPipeline::VulkanRenderPipeline(const Ref<VulkanGraphicsContext> &context, const Ref<VulkanRenderPass> &renderPass, const Ref<VulkanShader> &shader, const InputLayout &layout) : m_Context(context), m_RenderPass(renderPass), m_Shader(shader) {			
			...
			JD_VULKAN_CALL(vkCreatePipelineLayout(
			...
			JD_VULKAN_CALL(vkCreateGraphicsPipelines(
				m_Context->GetLogicalDevice(),
				VK_NULL_HANDLE,
				1,
	...
	namespace Native {
		...
		Ref<NativeRenderPipeline> NativeRenderPipeline::Create(const Ref<NativeGraphicsContext> &context, const Ref<NativeRenderPass> &renderPass, const Ref<NativeShader> &shader, const InputLayout &layout) {
